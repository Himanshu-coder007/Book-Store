    ...
    <div className="min-h-screen bg-pink-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          className="bg-white rounded-2xl shadow-xl overflow-hidden border border-pink-200 p-6"
        >
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-8">
            ...
            <div className="flex-shrink-0 w-full md:w-1/4 lg:w-1/5">
              {book.volumeInfo.imageLinks?.thumbnail ? (
                <motion.div
                  className="relative w-full h-64 md:h-80 flex items-center justify-center bg-pink-100 rounded-lg"
                ...
                <div className="w-full h-64 md:h-80 flex items-center justify-center bg-pink-200 rounded-lg">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start gap-4">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-pink-900 mb-2">
                    {book.volumeInfo.title}
                  </h1>
                  {book.volumeInfo.subtitle && (
                    <h2 className="text-lg md:text-xl text-pink-700 mb-4">
                      {book.volumeInfo.subtitle}
                    </h2>
                  )}
                </div>
